...
const FAQS = [
  ...
  { q: "Do you operate at night?", a: "Yes. TyreNinja runs 24/7/365. Whether it's 3am on the M25 or a Sunday morning in the Lakes, a local pro is on call." },
...
const Index = () => {
  ...
  const smsHref = `sms:${SMS_NUMBER}?body=${encodeURIComponent(
    "TyreNinja — flat tyre, my postcode is "
  )}`;
    ...
    <main className="min-h-screen bg-background">
            ...
            <div className="rounded-[2rem] border border-white/15 bg-card p-4 text-foreground shadow-elegant">
              ...
              <div className="space-y-2">
                ...
                <div className="w-fit max-w-[85%] rounded-2xl rounded-bl-sm bg-muted px-3 py-2 text-sm">
                  Hi! Sam (TyreNinja) here — 12 mins away. £65 to plug & inflate. Reply YES to confirm.
                </div>
                <div className="ml-auto w-fit max-w-[40%] rounded-2xl rounded-br-sm bg-accent px-3 py-2 text-sm text-accent-foreground">
                  YES
                </div>
                <div className="w-fit max-w-[85%] rounded-2xl rounded-bl-sm bg-muted px-3 py-2 text-sm">
                  On my way 🛻 Track me here: tyreninja.co.uk/t/8fJ
                </div>
              </div>
            </div>
      ...
      <section className="relative overflow-hidden bg-hero py-16 text-primary-foreground md:py-24">
        <div className="container text-center">
          ...
          <p className="mx-auto mt-4 max-w-xl text-white/80">
            Text us right now — your local TyreNinja pro is standing by.
          </p>
      ...
      <footer className="border-t border-border bg-primary text-primary-foreground">
        ...
        <div className="border-t border-white/10 py-4 text-center text-xs text-white/60">
          © {new Date().getFullYear()} TyreNinja Ltd. All rights reserved.
        </div>
      </footer>
    </main>
  );
