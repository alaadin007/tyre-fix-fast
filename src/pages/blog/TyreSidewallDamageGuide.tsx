...
export default function TyreSidewallDamageGuide() {
  return (
    <BlogPost
      ...
      intro="This tyre sidewall damage guide covers the one category of tyre problem where there is very little grey area — including what a replacement typically costs. The tread you can repair. The sidewall you almost always can't. Here's the plain-English rule set — what to look for, what BS AU 159 (the UK repair standard) says, and when you're driving on a bomb."
      howTo={ name: "How to inspect your tyre sidewalls for damage", fromHeading: "How to inspect your own sidewalls" }
      blocks={[
