...
export default function MobilePunctureRepairLondon() {
  return (
    <BlogPost
      ...
      intro="Mobile puncture repair in London ranges from £25 to £85 for what looks like the same job. It isn't. Here's exactly what a legitimate repair includes, why the cheap end is usually illegal, and how to book the right thing the first time."
      blocks={[
        ...
        { type: "p", html: "In those cases a good mobile fitter should carry stock in your size and be able to fit a replacement on the spot for a fixed price you were quoted before the van left." },
        ...
        { type: "h2", text: "Response times across London" },
        { type: "p", html: "For non-emergency mobile puncture repair (i.e. you booked in advance), typical arrival windows in 2026:" },
        {
          type: "ul",
          items: [
            "<strong>Same-day (booked before noon):</strong> 2–4 hour window",
            "<strong>Next-day:</strong> 90-minute window",
            "<strong>Emergency (right now):</strong> 30–90 minutes depending on zone",
          ],
        },
        { type: "p", html: "The advantage of same-day (vs emergency) is you get a narrower window and it's £5–£10 cheaper because it slots into the fitter's route." },

        { type: "h2", text: "Best locations to have it done in London" },
        {
          type: "ul",
          items: [
            ...
            "<strong>Red Route or Congestion Zone kerb</strong> — possible for a genuine breakdown, but move if you can",
          ],
        },
        ...
        { type: "h2", text: "What to have ready before the van arrives" },
        {
          ...
          items: [
            ...
            "A dry patch of ground if it's raining — under a carport or lock-up if possible (though we work in rain routinely)",
          ],
        },

        { type: "h2", text: "The London-specific gotchas" },
        { type: "p", html: "<strong>ULEZ:</strong> a mobile puncture repair van is almost always compliant — it doesn't affect your quote. <strong>Congestion Charge:</strong> most central London operators absorb this in a small surcharge. <strong>Low bridges and narrow lanes:</strong> in old-Chelsea or Soho streets, some operators can't get their van in — say what road you're on when you book. <strong>Estate parking permits:</strong> we don't need one for a 45-minute stop; just tell reception a mobile fitter is coming." },

        { type: "h2", text: "The 90-second booking flow" },
        { type: "p", html: "Send postcode, reg, tyre size (photo of the sidewall), and where the puncture is. You get a firm all-in quote, a specific ETA, and a live update when the van is 10 minutes away. That's what mobile puncture repair in London should look like in 2026 — anything more complicated and you're using the wrong service." },
      ]}
      faqs={[
        { q: "How much does mobile puncture repair cost in London?", a: "£45–£65 for a proper internal plug-patch fitted to BS AU 159, including rebalance and torque. Evening and overnight jobs add £10–£40." },
        ...
        { q: "Can a mobile fitter do the job while I'm at work?", a: "Yes. Office car parks are ideal — the van fits, we take 40 minutes, and you get on with your day." },
      ]}
