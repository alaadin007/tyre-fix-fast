...
const Terms = () => {
  return (
    ...
    >
      <Seo title="Terms & Conditions | Tyrefly Mobile Tyre Fitting UK" description="The terms that apply when you book Tyrefly mobile tyre fitting or puncture repair: quotes, payment, cancellations, liability and complaints." canonical="/terms" />
