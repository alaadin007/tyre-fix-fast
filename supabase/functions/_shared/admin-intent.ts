...
- UPDATE_TECHNICIAN_PRICE: change a technician's quoted price for a job BEFORE sending. Common typos for "change" (chance, chnage, chagne) and "update" (updte, udpate) MUST also map here, even when no new price value is given yet. e.g. "update Hassan price for #3EB08B to £55", "update TECH-0001 to £60 for #3EB08B", "change Omar price for #3EB08B to £48", "update TECH-0001 to £60 and TECH-0004 to £48 for #3EB08B", "chance price for #3EB08B for TECH-0001", "chnage price for #3EB08B to £55", "chagne TECH-0001 price for #3EB08B", "change price for #3EB08B for TECH-0001".
