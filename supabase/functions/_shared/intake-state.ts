...
Specific issue words that DO open intake: puncture, puncher, flat, blowout,
blown out, burst, deflated, low pressure, losing air, losing pressure, no
pressure, nail in tyre, screw in tyre, slow puncture, tyre gone, shredded,
slashed, ripped, or clear emergency ("I'm stuck", "stranded", "broken down",
"on the motorway", "come to me now").

Vague messages that MUST clarify first (never open intake): "I need tyre help",
"I need help with my tyre", "I have a tyre issue", "Tyre problem", "My tyre
needs attention", "Something wrong with my tyre", "Can someone look at my
tyre/wheel", "I need help with my wheel".
